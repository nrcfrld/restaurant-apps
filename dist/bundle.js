  ...
  <div class="container">
    <div class="restaurant-detail">
      <div class="restaurant-detail-thumbnail">
        <picture>
          <source class="restaurant-image" srcset="https://restaurant-api.dicoding.dev/images/large/${t.pictureId}" media="(min-width: 992px)">
          <source class="restaurant-image" srcset="https://restaurant-api.dicoding.dev/images/medium/${t.pictureId}" media="(min-width: 768px)">
          <img class="restaurant-image" src="https://restaurant-api.dicoding.dev/images/small/${t.pictureId}" alt="Some picture">
        </picture>
      </div>
