...
<section id="favorites">
    <div class="container">
      ...
      `}}},g={init({button:t,drawer:e,content:a}){t.addEventListener("click",t=>{this._toggleDrawer(t,e)}),a.addEventListener("click",t=>{this._closeDrawer(t,e)})},_toggleDrawer(t,e){t.stopPropagation(),e.classList.toggle("open")},_closeDrawer(t,e){t.stopPropagation(),e.classList.remove("open")}};var e=class{constructor({button:t,drawer:e,content:a}){this._button=t,this._drawer=e,this._content=a,this._initiateAppShell()}_initiateAppShell(){g.init({button:this._button,drawer:this._drawer,content:this._content})}async renderPage(){var t=o.parseActiveUrlWithCombiner();const e=h[t];console.log(`Url : ${t}`),this._content.innerHTML=await e.render(),await e.afterRender()}},s=a(2),f=a.n(s),b=()=>{"serviceWorker"in navigator?f.a.register():console.log("Service worker not supported in this browser")};a(4),a(5),a(0),a(9);const v=new e({button:document.querySelector(".navbar .navbar--toggle"),drawer:document.querySelector(".navbar .nav--list"),content:document.querySelector("#main-content")});window.addEventListener("hashchange",()=>{v.renderPage()}),window.addEventListener("load",()=>{v.renderPage(),b()})}]);