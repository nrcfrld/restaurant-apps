  ...
  <div class="container">
    <div class="restaurant-detail">
      <div class="restaurant-detail-thumbnail">
        <picture>
          <source class="lazyload" data-srcset="https://restaurant-api.dicoding.dev/images/large/${t.pictureId}" media="(min-width: 992px)">
          <source class="lazyload" data-srcset="https://restaurant-api.dicoding.dev/images/medium/${t.pictureId}" media="(min-width: 768px)">
          <img class="restaurant-image lazyload" data-src="https://restaurant-api.dicoding.dev/images/small/${t.pictureId}" alt="${t.name}">
        </picture>
      </div>
